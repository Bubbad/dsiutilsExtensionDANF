...
public class HyperLogLogCounterArray implements Serializable, Cloneable {
	...
	protected long size;
	private String exceptionString = "Exception in " + it.unimi.dsi.util.HyperLogLogCounterArray.class + ". ";
	...
	@Override
	public Object clone(){
		HyperLogLogCounterArray clone;
		try {
			clone = (HyperLogLogCounterArray) super.clone();
	...
	public HyperLogLogCounterArray extract(LazyLongIterator indices, long numberOfIndices){
		HyperLogLogCounterArray extracted = new HyperLogLogCounterArray(numberOfIndices,numberOfIndices,log2m,seed);
	 ...
	 */
	public void union(long index, HyperLogLogCounterArray from, long fromIndex) throws IllegalArgumentException{
	 ...
	 * @param from
	 */
	public void union(HyperLogLogCounterArray from){
	...
	public void transferNodeFrom(long index, HyperLogLogCounterArray from){
