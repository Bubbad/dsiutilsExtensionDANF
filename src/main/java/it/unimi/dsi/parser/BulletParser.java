 ...
 * from <a href="http://fastutil.dsi.unimi.it/"><code>fastutil</code></a>, which
...
public class BulletParser {
	 ...
	 * in new code!). All such ampersand should be specified as <code>&amp;amp;</code>. 
	 ...
	 * 
	 * @param text the text.
	 * @param pos the first character in the markup after <code>&lt;!</code>.
